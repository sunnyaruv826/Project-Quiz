    ...
    const questions = [
        {
            ...
            options: ["<pre>",
              ...
              title: 'How to create a hyperlink in HTML?',
            options: [
              ...
              {
                title: 'How to create an ordered list (a list with the list items in numbers) in HTML?',
            options: [
                '<ul>',
                '<ol>',
                '<li>',
                ...
                {
                title: 'In a CSS file, there is a CSS rule for paragraphs tags – what does p can be called?',
            options: [
                'Selector',
                'Attribute',
                'Property',
